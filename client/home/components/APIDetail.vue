...
<div>
            ...
            <div class="api-wrapperBox">
                <v-row class="text-center ma-0">
                    ...
                    <v-col md="10" class="text-left">
                        <p class="monospace-text ma-0">
                            <span class="blue-grey--text" :ref="`endpoint_${product.id}_code_ref`">
        ...
        <v-card-subtitle> Header </v-card-subtitle>
            ...
            <div class="code-snippetWrapper">
                ...
                <pre  :ref="`header_${product.id}_code_ref`">{{product.header_json | formatjson}} </pre>
            </div>
        </div>
        ...
        <v-card-subtitle> Body </v-card-subtitle>
            ...
            <div class="code-snippetWrapper">
                <div class="code-snippetArea">
                    ...
                    <pre  :ref="`body_${product.id}_code_ref`">{{product.body_json | formatjson}} </pre>
...
module.exports= {
    ...
    methods:{
        copyCode(element){
            ...
            var code = this.$refs[element+'_'+this.product.id+'_code_ref'].innerHTML;
